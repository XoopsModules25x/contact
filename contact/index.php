...
/*Modules Options*/
if ($contacts->getConfig('form_dept') == 1) {
    ...
    $xoopsTpl->assign('depart', $contacts->getConfig('form_dept'));
    $xoopsTpl->assign('departments', $departmentlist);
}
$xoopsTpl->assign('recaptcha', $contacts->getConfig('recaptchause'));
$xoopsTpl->assign('recaptchakey', $contacts->getConfig('recaptchakey'));
$xoopsTpl->assign('url', $contacts->getConfig('form_url'));
$xoopsTpl->assign('icq', $contacts->getConfig('form_icq'));
$xoopsTpl->assign('skype', $contacts->getConfig('form_skype'));
$xoopsTpl->assign('company', $contacts->getConfig('form_company'));
$xoopsTpl->assign('location', $contacts->getConfig('form_location'));
$xoopsTpl->assign('phone', $contacts->getConfig('form_phone'));
$xoopsTpl->assign('address', $contacts->getConfig('form_address'));

$xoopsTpl->assign('map', $contacts->getConfig('embed_maps'));
/*end Modules options*/
// Breadcrumbs
$xoBreadcrumbs[] = array('title' => _YOURHOME);
//$xoopsTpl->assign('breadcrumb', '<li><a href="' . XOOPS_URL . '">' . _YOURHOME . '</a></li> <li class="active">' . $xoopsModule->name().'</li>');
$xoopsTpl->assign('info', $contacts->getConfig('contact_info'));
