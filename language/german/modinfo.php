...
define('_MI_CONTACT_FORM_CAPTCHA_REGISTERED', "Captcha für registrierte User verwenden?");
define('_MI_CONTACT_FORM_CAPTCHA_DESC', "Wähle <em>Ja</em>, um Captcha im Eingabeformular zu verwenden.<br />Standard: <em>Ja</em>");
define('_MI_CONTACT_DEPT', "Abteilungen");
define('_MI_CONTACT_DEPT_DESC', "Diese Option erlaubt die Angabe/Kombination von verschiedenen Abteilungen/Empfängern. Je nach Benutzerauswahl<br />"
    . "erhält die entsprechende Abteilung die jeweilige Kontaktinformation <br />"
    . "an die dafür definierte E-Mail-Adresse.<br /><br />"
...
define('_MI_CONTACT_BACK_2_ADMIN', 'Zurück zur Administration von ');
define('_MI_CONTACT_OVERVIEW', 'Übersicht');
